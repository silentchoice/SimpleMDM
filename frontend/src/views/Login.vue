          ...
          <el-col :span="24" v-for="acc in demoAccounts" :key="acc.user">
            <el-button size="small" text style="width: 100%;" @click="fillAccount(acc)">
              <div style="text-align: left; line-height: 1.4;">
                ...
                <div style="font-size: 11px; color: #c0c4cc;">{{ acc.user }}</div>
              </div>
            </el-button>
          </el-col>
        </el-row>
...
const demoAccounts = [
  { label: '系统管理员', user: 'admin' },
  { label: '人力资源审批员', user: 'hr_approver' },
  { label: '人力资源编辑员', user: 'hr_editor' },
  { label: '人力资源查看员', user: 'hr_viewer' },
]
