...
public class ChildType {
    ...
    public void apply(com.simplemdm.dto.mdm.MetadataCommands.UpdateChildType command, Long actorId) {
        name = command.name(); sortOrder = command.sortOrder(); updatedBy = actorId;
    }
