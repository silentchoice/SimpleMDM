...
public class ApprovalAction {
 ...
 protected ApprovalAction(){} public static ApprovalAction submitted(Long s,Long r,Long a){return action(s,r,a,"SUBMIT");} public static ApprovalAction approved(Long s,Long r,Long a){return action(s,r,a,"APPROVE");} private static ApprovalAction action(Long s,Long r,Long a,String action){ApprovalAction x=new ApprovalAction();x.systemId=s;x.approvalRequestId=r;x.actorId=a;x.action=action;return x;}
