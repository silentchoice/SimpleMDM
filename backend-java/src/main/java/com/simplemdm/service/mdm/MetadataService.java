...
public class MetadataService {
    ...
    public FieldDefinition createField(Long objectTypeId, CreateFieldCommand command) {
        ...
        ObjectType referenceObjectType = resolveReferenceObjectType(objectType, command);
        try {
    ...
    public ObjectType validateAndResolveReference(ObjectType objectType, CreateFieldCommand command) {
        validate(command);
        return resolveReferenceObjectType(objectType, command);
    }

    private ObjectType resolveReferenceObjectType(ObjectType objectType, CreateFieldCommand command) {
