...
class FullJpaSchemaValidationTest {
    ...
    @Test
    void everyRuntimeEntityValidatesAgainstTheLatestFlywaySchema() {
        ...
        try {
            ...
            assertThat(factory.getObject().getMetamodel().getEntities())
                .extracting(entity -> entity.getJavaType().getSimpleName())
                .contains("ApprovalChildChange", "ApprovalChildValueChange");
        } finally {
            factory.destroy();
        }
    }
